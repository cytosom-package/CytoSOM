#' Hitogram representation of a marker in a given meta-cluster, compared to the full data
#'
...
HistMarkerMetaCl = function(TreeMetaCl,Marker,MetaCl,breaks=100,xlim=NULL,freq=TRUE) {
